...
export class ProgramService extends BaseService {
    ...
    public listProgramsByCategory(categoryId: number, pageInfo: PageInfo): Observable<Array<ProgramInfo> | null> {
        return super.httpPostArrayModel<ProgramInfo>(ProgramInfo, `${environment.request.endPoints.program.listProgramsByCategory}/${categoryId}`, pageInfo);
    }
